                ...
                <div class="card-body">
                    ...
                    <c:if test="${empty product}">
                        <div class="alert alert-warning">
                            ...
                            <a href="${pageContext.request.contextPath}/products/customer" class="alert-link">Go back to products</a>.
                        </div>
                    </c:if>
                                    ...
                                    <form id="orderForm" action="${pageContext.request.contextPath}/orders/confirm" method="post" class="mt-4" novalidate>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="address" name="address" rows="3" 
                                                      minlength="10" maxlength="200" required>${formData.address}</textarea>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="deliveryNotes" name="deliveryNotes" rows="2" 
                                                      maxlength="200"
                                                      placeholder="Any special instructions for delivery...">${formData.deliveryNotes}</textarea>
                                            <div class="invalid-feedback">
